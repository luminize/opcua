...
int main(void) {
    ...
    oAttr.description = UA_LOCALIZEDTEXT("en-US", "A dog named Pien");
    oAttr.displayName = UA_LOCALIZEDTEXT("en-US", "Pien");
    UA_Server_addObjectNode(server, UA_NODEID_NUMERIC(1, 0),
                            UA_NODEID_NUMERIC(0, UA_NS0ID_OBJECTSFOLDER),
                            UA_NODEID_NUMERIC(0, UA_NS0ID_HASCOMPONENT),
                            UA_QUALIFIEDNAME(1, "Pien"), UA_NODEID_NUMERIC(1, 10002),
                            oAttr, NULL, NULL);
